 ...
 */
public class EightLengthFieldDecoder extends ByteToMessageDecoder {
	
	private final Logger logger = Logger.getLogger(EightLengthFieldDecoder.class);
     ...
     */
    public EightLengthFieldDecoder(
            int maxFrameLength,
            int lengthFieldOffset) {
        this(maxFrameLength, lengthFieldOffset, 0);
    }
    ...
    public EightLengthFieldDecoder(
        ...
        this(
                maxFrameLength,
                lengthFieldOffset, lengthAdjustment,true);
    }
    ...
    public EightLengthFieldDecoder(
            ...
            int lengthAdjustment, boolean failFast) {
        this(
                ByteOrder.BIG_ENDIAN, maxFrameLength, lengthFieldOffset,
                lengthAdjustment, failFast);
    }
     ...
     *        has been read.
     */
    public EightLengthFieldDecoder(ByteOrder byteOrder, int maxFrameLength, int lengthFieldOffset,
            int lengthAdjustment, boolean failFast) {
        if (byteOrder == null) {
    ...
    protected Object decode(ChannelHandlerContext ctx, ByteBuf in) throws Exception {
        ...
        if (frameLength < 0) {
            ...
            throw new CorruptedFrameException(
                    "negative pre-adjustment length field: " + frameLength+"log"+log);
        }
